var Data = (function () {
    ...
    function readFileFromServer(filename) {
      ...
      function readFileFolderFromServer(folder) {
            var request = new XMLHttpRequest();
            if (!request) {
                console.log('Error: No XMLHttpRequest instance.');
                return false;
    ...
    */
    function calcStats(data) {
        ...
        console.log("stats filed : i= " + i +"  " + JSON.stringify(stats.field[i]));
            stats.min[i] = min;
            stats.max[i] = max;
            stats.range[i] = max - min;
            stats.mean[i] = mean;
        }
        console.log("stats filed : " + stats.field);
    ...
    return {
        ...
        readFileFolderFromServer: readFileFolderFromServer
    };
}());
