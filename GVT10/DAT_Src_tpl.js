...
var prefixStr = 'Accelerometer'
var folderArray = ['Brush_teeth', 'Climb_stairs', 'Comb_hair', 'Descend_stairs', 'Drink_glass'];
var fileArray = [prefixStr + '2011-04-11-13-28-18-brush_teeth-f1','','','','','','','','','','','']

var a1 = 'data/materials/HMP_Dataset/Brush_teeth/Accelerometer-2011-04-11-13-28-18-brush_teeth-f1.txt';
var a2 = "data/materials/HMP_Dataset/Brush_teeth/Accelerometer-2011-04-11-13-29-54-brush_teeth-f1.txt";
var a3 = "data/materials/HMP_Dataset/Brush_teeth/Accelerometer-2011-05-30-08-35-11-brush_teeth-f1.txt";
var a4 = "data/materials/HMP_Dataset/Brush_teeth/Accelerometer-2011-05-30-09-36-50-brush_teeth-f1.txt";
var a5 = "data/materials/HMP_Dataset/Brush_teeth/Accelerometer-2011-05-30-10-34-16-brush_teeth-m1.txt";
var a6 = "data/materials/HMP_Dataset/Brush_teeth/Accelerometer-2011-05-30-21-10-57-brush_teeth-f1.txt";
var currentFile;
var _arr = [a1,a2,a3,a4,a5,a6];

var file1 = {
        adl : 'brush_teeth',
        date : '2011-04-11-13-28-18',
        volunteer : 'f1'
};

var file2 = {
        adl : 'brush_teeth',
        date : '2011-04-11-13-29-54',
        volunteer : 'f1'
};

var file3 = {
        file3 : 'brush_teeth',
        date : '2011-05-30-08-35-11',
        volunteer : 'f1'
};

var file4 = {
      adl : 'brush_teeth',
      date : '2011-05-30-09-36-50',
      volunteer : 'f1'
};
    ...
    function start() {
       ...
       // Data.readFileFromServer('data/HabermansSurvivalDataSet/haberman.data');
        Data.readFileFolderFromServer(a1);
    }
    ...
    function initEventHandler() {
        ...
        window.onkeydown = function (evt) {
            ...
            switch (c){
                ...
                var now = 'a' + currentFile;
                Data.readFileFromServer(_arr[currentFile]);
                return;
            }
